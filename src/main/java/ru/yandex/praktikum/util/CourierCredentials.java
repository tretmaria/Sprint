...
public class CourierCredentials {
    ...
    public static CourierCredentials authorizeWithLogin(Courier courier) {
        return new CourierCredentials().setLogin(courier.login);
    }

    public static CourierCredentials authorizeWithPassword(Courier courier) {
        return new CourierCredentials().setPassword(courier.password);
    }

    public static CourierCredentials authorizeWithRandomCredentials(Courier courier) {
